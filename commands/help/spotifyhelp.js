...
module.exports = {
    ...
    execute(message) {
        const embed = new MessageEmbed()
            ...
            .addField('Thread Count', 'Specify a number between 1-1000 to control how many threads to use for processing. Higher thread counts will process files faster but use more resources.\nExample: `.spotifycheck 500` will use 500 threads')
